...
<html lang="en">
  <head>
    ...
    <meta name="description" content="A Simple and Lightweight Mixin Library for Sass.">
    <title>Bourbon - A Sass Mixin Library</title>
...
<div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="c1">// Bourbon mixin with Sass</span>

<span class="nt">section</span> <span class="p">{</span>
  <span class="k">@include</span><span class="nd"> linear-gradient</span><span class="p">(</span><span class="n">to</span> <span class="no">top</span><span class="o">,</span> <span class="nb">red</span><span class="o">,</span> <span class="ni">orange</span><span class="p">);</span>
<span class="p">}</span></code></pre></div>
      </div>

      <div class="css-wrapper">
<div class="highlight"><pre><code class="language-css" data-lang="css"><span class="c">/* Compiled CSS  */</span>

<span class="nt">section</span> <span class="p">{</span>
  <span class="k">background-color</span><span class="o">:</span> <span class="nb">red</span><span class="p">;</span>
  <span class="k">background-image</span><span class="o">:</span> <span class="o">-</span><span class="n">webkit</span><span class="o">-</span><span class="n">linear</span><span class="o">-</span><span class="n">gradient</span><span class="p">(</span><span class="k">bottom</span><span class="o">,</span> <span class="nb">red</span><span class="o">,</span> <span class="nb">orange</span><span class="p">);</span>
  <span class="k">background-image</span><span class="o">:</span>         <span class="n">linear</span><span class="o">-</span><span class="n">gradient</span><span class="p">(</span><span class="n">to</span> <span class="k">top</span><span class="o">,</span> <span class="nb">red</span><span class="o">,</span> <span class="nb">orange</span><span class="p">);</span>
<span class="p">}</span></code></pre></div>
    </div>
...
<span class="nt">h1</span> <span class="p">{</span>
  ...
  <span class="k">font-size</span><span class="o">:</span> <span class="m">23px</span><span class="p">;</span>
<span class="p">}</span></code></pre></div>
      </div>
    </div>
  </section>
  ...
  <section class="usage">
    <div class="container">
      ...
      <section class="install-instructions">
        ...
        <p>In your Gemfile:</p>
<div class="highlight"><pre><code class="language-powershell" data-lang="powershell"><span class="n">gem</span> <span class="s1">&#39;bourbon&#39;</span></code></pre></div>

        <p>Then run:</p>
<div class="highlight"><pre><code class="language-powershell" data-lang="powershell"><span class="p">$</span> <span class="n">bundle</span> <span class="n">install</span></code></pre></div>

        <p>Restart your server. Then rename <code>application.css</code> to <code>application.css.scss</code>:</p>
<div class="highlight"><pre><code class="language-powershell" data-lang="powershell"><span class="n">mv</span> <span class="n">app</span><span class="p">/</span><span class="n">assets</span><span class="p">/</span><span class="n">stylesheets</span><span class="p">/</span><span class="n">application</span><span class="p">.</span><span class="n">css</span> <span class="n">app</span><span class="p">/</span><span class="n">assets</span><span class="p">/</span><span class="n">stylesheets</span><span class="p">/</span><span class="n">application</span><span class="p">.</span><span class="n">css</span><span class="p">.</span><span class="n">scss</span></code></pre></div>

        <p>Delete the sprocket directive in application.css.scss:</p>
<div class="highlight"><pre><code class="language-powershell" data-lang="powershell"><span class="p">*=</span> <span class="n">require_tree</span> <span class="p">.</span></code></pre></div>

        <p>Import Bourbon at the beginning of application.css.scss. All additional stylesheets must be imported below Bourbon:</p>
<div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="k">@import</span> <span class="s2">&quot;bourbon&quot;</span><span class="p">;</span>
<span class="k">@import</span> <span class="s2">&quot;home&quot;</span><span class="p">;</span>
<span class="k">@import</span> <span class="s2">&quot;users&quot;</span><span class="p">;</span></code></pre></div>
      </section>
      ...
      <section class="install-instructions">
        ...
        <h5>Installation</h5>
        <p>Install the gem</p>
<div class="highlight"><pre><code class="language-powershell" data-lang="powershell"><span class="p">$</span> <span class="n">gem</span> <span class="n">install</span> <span class="n">bourbon</span></code></pre></div>

        <p>Install Bourbon into your project’s <code>stylesheets</code> directory by generating the <code>bourbon</code> folder:</p>
<div class="highlight"><pre><code class="language-powershell" data-lang="powershell"><span class="p">$</span> <span class="n">bourbon</span> <span class="n">install</span></code></pre></div>
...
<div class="highlight"><pre><code class="language-powershell" data-lang="powershell"><span class="p">$</span> <span class="n">sass</span> <span class="p">-</span><span class="n">-watch</span> <span class="n">stylesheets</span><span class="p">/</span><span class="n">sass</span><span class="err">:</span><span class="n">stylesheets</span></code></pre></div>

        <p>Lastly, import the mixins at the beginning of your stylesheet(s):</p>
<div class="highlight"><pre><code class="language-scss" data-lang="scss"><span class="k">@import</span> <span class="s2">&quot;bourbon/bourbon&quot;</span><span class="p">;</span></code></pre></div>
...
<div class="highlight"><pre><code class="language-powershell" data-lang="powershell"><span class="p">$</span> <span class="n">bourbon</span> <span class="n">help</span>
<span class="p">$</span> <span class="n">bourbon</span> <span class="n">update</span></code></pre></div>
...
<footer>
  <div class="container">
    ...
    <script src="js/vendor/jgestures.min.js"></script>
